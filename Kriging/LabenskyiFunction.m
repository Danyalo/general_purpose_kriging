function [integral] = LabenskyiFunction(p11, p12, p21, p22)
%UNTITLED3 Returns the integral of solutions of system of diff equations 
%   p11, p12, p21, p22 - coefficients for the system of diff equations
...
diap = [0 1];
y0 = [1 1];
[t,result] = solvedyfsystem(diap, y0, p11, p12, p21, p22);
